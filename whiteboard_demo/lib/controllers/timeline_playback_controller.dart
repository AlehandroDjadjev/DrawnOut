...
class TimelinePlaybackController extends ChangeNotifier {
  ...
  void Function()? onSegmentChangedCompleted;  // Called after segment fully completes
  ...
  Future<void> _playSegment(int index) async {
    ...
    debugPrint('🎬 Playing segment $index: "${segment.speechText.substring(0, segment.speechText.length > 50 ? 50 : segment.speechText.length)}..."');
