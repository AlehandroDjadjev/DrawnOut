...
urlpatterns = [
    ...
    path("listings/cancel/<int:listing_id>/", CancelListingView.as_view()),
    ...
    path("proposals/withdraw/<int:proposal_id>/", WithdrawTradeProposalView.as_view()),
