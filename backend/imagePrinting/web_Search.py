...
def search_image_by_keywords(keywords):
    ...
    try:
        ...
        if "value" in data and len(data["value"]) > 0:
            return {"image_url": data["value"][0]["contentUrl"]}
        else:
            return {"image_url": "https://via.placeholder.com/600x400.png?text=No+Image+Found"}
    except Exception as e:
        print("Bing Image Search Error:", e)
        return {"image_url": "https://via.placeholder.com/600x400.png?text=Error+Fetching+Image"}
